...
@dataclasses.dataclass(frozen=True, kw_only=True)
class AsyncContext[** Params, Return](_context.Async.Context[Params, Return], ContextData[Params]):
...
@dataclasses.dataclass(frozen=True, kw_only=True)
class SyncContext[** Params, Return](_context.Multi.Context[Params, Return], ContextData[Params]):
